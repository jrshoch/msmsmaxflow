...
public class DualFactoryTest {
    ...
    public void testGetCounterClockwiseCycle() {
        ...
        // Check to sure sure the correct edges separate two adjacent faces of
        // the dual.
        // In particular, for two vertices in the primal graph, their
        // corresponding faces
        // in the dual should be separated by an edge in the dual which is
        // mapped to an
